...
- [Hex Editor and Comparer](https://koudelkab.github.io/singleHtmlApps/HexEditorAndComparer.html) - Hex editor for inspecting, editing, and comparing binary files, with search, selection, and download support.
