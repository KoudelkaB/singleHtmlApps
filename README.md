...
- [Generátor osmisměrek](https://koudelkab.github.io/singleHtmlApps/OsmismerkaGenerator.html) - Czech word-search builder with a fixed secret phrase, required words, optional dictionary words, solution highlighting, print, and TXT export.
- Print File Tools/
...
- Most apps are designed to open files you drop into the page, and some support multiple files or bundled inputs.
